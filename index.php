...
function loginForm(){
    echo
    '<div id="loginform">
    <p>Pick a name to continue</p>
    <form action="index.php" method="post">
      <input placeholder="Enter Name Here" type="text" name="name" id="name" />
...
<html lang="en">
    ...
    ?>
      ...
      <button type="button" onclick="clearchat()" id="clearchat">Clear Chat</button>
                ...
                <p class="logout"><a id="exit" href="#">Exit & Log Out</a></p>
            </div>
            ...
            <form name="message" action="">
                <input placeholder="Type a message" name="usermsg" type="text" id="usermsg" />
